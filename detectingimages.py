...
def train_data():
    ...
    results = yolo_model.train(data='data.yaml', epochs=3)
    results = yolo_model.export(format='torchscript')
...
def detect_objects_in_video(video_path):
    ...
    result_video_path = "Results/detected_objects_video.mp4"
